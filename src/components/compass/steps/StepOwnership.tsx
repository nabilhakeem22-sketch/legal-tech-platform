        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    />
                    <div className="min-w-[50px] text-center font-bold text-lg text-indigo-600 border border-indigo-100 bg-indigo-50 rounded px-2 py-1">
                        {state.shareholders}
                    </div>
                </div>
            ...
            <div className="space-y-4">
                ...
                {state.country === "Egypt" && (state.nationality === "Foreign" || state.nationality === "Mixed") && (
                    <div className="rounded-md bg-yellow-50 p-4 border border-yellow-200 animate-in fade-in">
                        <div className="flex">
                            <div className="flex-shrink-0">
                                <ShieldAlert className="h-5 w-5 text-yellow-400" />
                            </div>
                            <div className="ml-3">
                                <h3 className="text-sm font-medium text-yellow-800">Security Clearance Required</h3>
