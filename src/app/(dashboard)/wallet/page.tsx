            ...
            <div className="grid gap-4 md:grid-cols-3">
                <Card className="bg-indigo-600 text-white border-indigo-500">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-indigo-200 mt-1">+8% from last month</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-gray-500 mt-1">4 active retainers</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-gray-900">$18,200.00</div>
                        <p className="text-xs text-gray-500 mt-1">Projected: $20k</p>
                    </CardContent>
                </Card>
            </div>
