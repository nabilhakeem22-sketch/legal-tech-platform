    ...
    return (
        <div className="space-y-8 pb-10 h-full flex flex-col">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight text-foreground">Tax Management</h2>
                    <p className="mt-2 text-sm text-muted-foreground">Monitor deadlines, prepare filings, and ensure compliance for all entities.</p>
                </div>
                <div className="flex items-center gap-3">
                    <div className="flex bg-muted p-1 rounded-lg">
                        ...
                        <button
                            ...
                            className={cn(
                                "flex items-center px-3 py-1.5 rounded-md text-sm font-medium transition-all",
                                viewMode === "kanban" ? "bg-background text-primary shadow-sm" : "text-muted-foreground hover:text-foreground"
                            )}
                        >
                        ...
                        <button
                            ...
                            className={cn(
                                "flex items-center px-3 py-1.5 rounded-md text-sm font-medium transition-all",
                                viewMode === "calendar" ? "bg-background text-primary shadow-sm" : "text-muted-foreground hover:text-foreground"
                            )}
                        >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="rounded-lg bg-orange-500/10 p-4 border border-orange-500/20">
                                <div className="flex">
                                    ...
                                    <div className="ml-3">
                                        <h3 className="text-sm font-medium text-orange-600">Urgent Attention</h3>
                                        <div className="mt-2 text-sm text-orange-600/90">
